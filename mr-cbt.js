...
function cbtEnc(A,cut){
	...
	var b=32,B,e=A.length,l,m=1/0,n=e,cs=0,nc,nl=0,o=n,H=[],C=Array(n),P=Array(n),N=Array(n),S=[],O=[],Q=[],T=[];
	O.e=function(l,n){
	...
	if(b<32)for(;B;B<<=8)O[o++]=B>>>24;l=A.length;
	if(o>l){
		for(m=n=o=B=O.length=0,b=32;l>>++m;);
		for(O.e(6,m),O.e(--m+9,(l^1<<m)<<9);n<l;)O.e(8,A[n++])
